    ...
    if (orderSuccess) {
        return (
            <div className="min-h-screen bg-[#FDFBF7] flex flex-col items-center justify-center p-6 text-center">
                ...
                <div className="bg-blue-50 p-4 rounded-xl border border-blue-100 mb-6 max-w-xs text-left"><p className="text-blue-800 text-sm font-medium flex gap-2"><Info size={24} className="flex-shrink-0" />{orderType === 'delivery' ? "Mohon tunggu, kurir kami akan segera mengantar pesanan." : "Pesanan akan segera disiapkan. Mohon bersiap ke Kasir."}</p></div>
