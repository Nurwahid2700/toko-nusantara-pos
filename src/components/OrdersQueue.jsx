...
export default function UserOrder() {
    ...
    const [orderType, setOrderType] = useState('dine_in'); // Default Makan di tempat
    ...
    // --- PERBAIKAN: HARGA DIAMBIL MURNI (TANPA * 1000) ---
    // Pastikan di database harga tertulis "15000", bukan "15"
    ...
    const handleSubmitOrder = async (e) => {
        ...
        try {
            ...
            // Simpan Transaksi dengan Nominal Asli
    ...
    return (
        <div className="min-h-screen bg-[#FAFAFA] pb-24 max-w-md mx-auto shadow-2xl overflow-hidden relative">
            ...
            {/* LIST PRODUK - HARGA NORMAL (MURNI) */}
